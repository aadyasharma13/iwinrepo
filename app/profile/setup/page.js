...
export default function ProfileSetupPage() {
  ...
  const handleBasicInfoSubmit = (e) => {
    ...
    setBasicInfo({ displayName, bio, location });
    setCurrentStep(2);
  };
  ...
  const renderRoleSpecificForm = () => {
    switch (selectedRole) {
      case 'patient':
        return <PatientForm onSubmit={handleRoleFormSubmit} />;
      case 'caregiver':
        return <CaregiverForm onSubmit={handleRoleFormSubmit} />;
      case 'medical_professional':
        return <MedicalProfessionalForm onSubmit={handleRoleFormSubmit} />;
      default:
        return null;
    }
  };
