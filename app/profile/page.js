...
import StorytellingJournals from "@/components/profile/StorytellingJournals";
...
export default function ProfilePage() {
  ...
  const renderRoleSpecificProfile = () => {
    switch (user.role) {
      case "patient":
        return (
          <PatientProfile userData={user} onUpdate={handleProfileUpdate} />
        );
      case "caregiver":
        return (
          <CaregiverProfile userData={user} onUpdate={handleProfileUpdate} />
        );
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="p-6 text-center">
              <p className="text-gray-600">
                Contact support to set up your role-specific profile.
              </p>
            </div>
          </div>
        );
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 py-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 bg-emerald-50 p-6 rounded-2xl border border-emerald-200">
                    ...
                    <p className="text-xs text-gray-500 bg-white p-3 rounded-xl border border-emerald-200">
                      <svg
                        className="w-4 h-4 text-emerald-600 inline mr-1"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                      ...
                      Your location helps us connect you with local healthcare
                      resources and community members in your area.
                    </p>
                  </div>
          ...
          <div className="relative">
            ...
            {activeTab === "journals" && (user.role === "patient" || user.role === "caregiver") && <StorytellingJournals />}
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 capitalize">
                          Status:{" "}
                          {user.medicalVerification?.status || "Not submitted"}
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                        <div className="flex space-x-3">
                          ...
                          <div className="text-sm text-amber-800">
                            ...
                            <p className="mb-2">
                              Your credentials are being reviewed. This
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                        <div className="flex space-x-3">
                          ...
                          <div className="text-sm text-green-800">
                            ...
                            <p>
                              Your medical credentials have been verified. You
                              now have access to all professional features.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                        <div className="flex space-x-3">
                          ...
                          <div className="text-sm text-red-800">
                            ...
                            <p className="mb-2">
                              Your verification was unsuccessful. Please contact
